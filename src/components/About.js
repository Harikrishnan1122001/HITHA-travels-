...
//               Trusted Travel<br />
//               <span className="text-gold">Acting Drivers in Madurai</span>
//             </h2>
//           </div>

//           <p className="about-text reveal" style={{transitionDelay: '0.1s'}}>
//             Hitha Acting Driver's is Madurai's leading travel and cab service company, 
//             offering professional acting drivers, outstation trips, and custom tour packages 
//             across Tamil Nadu and India. Located at 9A, Dindigul Main Rd, Vilangudi, 
//             our team is committed to making every journey safe, comfortable, and memorable.
//           </p>

//           <p className="about-text reveal" style={{transitionDelay: '0.2s'}}>
//             Whether you need a reliable acting driver for your personal vehicle, an AC cab 
//             for airport pickup, or a fully planned tour package for your family — we've got 
//             you covered with our fleet of well-maintained vehicles and experienced drivers.
//           </p>

//           <div className="about-features reveal" style={{transitionDelay: '0.3s'}}>
//             {[
//               { icon: '🛡️', title: 'Safety First', desc: 'Background-verified, licensed drivers' },
//               { icon: '⏰', title: 'Always Punctual', desc: 'On-time pick-up & drop guaranteed' },
//               { icon: '📍', title: 'Local Expertise', desc: 'Deep knowledge of Tamil Nadu routes' },
//               { icon: '💰', title: 'Best Rates', desc: 'Transparent pricing, no hidden fees' },
//             ].map((f, i) => (
